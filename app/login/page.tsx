      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        <div className="bg-surface-card border border-surface-border rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center gap-4 mb-8">
            <div className="w-14 h-14 bg-brand-500/10 border border-brand-500/30 rounded-2xl flex items-center justify-center">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-xl transition-all duration-150 active:scale-95 shadow-sm"
          >
            {/* Google SVG icon */}
